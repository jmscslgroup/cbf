...
struct B_cbf_T {
  ...
  SL_Bus_cbf_std_msgs_Float64 In1;     // '<S17>/In1'
  SL_Bus_cbf_std_msgs_Float64 In1_p;   // '<S16>/In1'
  SL_Bus_cbf_std_msgs_Float64 In1_m;   // '<S15>/In1'
  SL_Bus_cbf_std_msgs_Float64 In1_f;   // '<S14>/In1'
  SL_Bus_cbf_std_msgs_Float64 In1_m3;  // '<S13>/In1'
};

// Block states (default storage) for system '<Root>'
struct DW_cbf_T {
  ros_slros_internal_block_GetP_T obj; // '<S12>/Get Parameter5'
  ...
  ros_slroscpp_internal_block_S_T obj_n0;// '<S10>/SourceBlock'
  ros_slroscpp_internal_block_S_T obj_o;// '<S9>/SourceBlock'
  ros_slroscpp_internal_block_S_T obj_ij;// '<S8>/SourceBlock'
...
//  '<S14>'  : 'cbf/Subscribe1/Enabled Subsystem'
//  '<S15>'  : 'cbf/Subscribe2/Enabled Subsystem'
//  '<S16>'  : 'cbf/Subscribe4/Enabled Subsystem'
//  '<S17>'  : 'cbf/Subscribe6/Enabled Subsystem'
//  '<S18>'  : 'cbf/Subscribe7/Enabled Subsystem'
